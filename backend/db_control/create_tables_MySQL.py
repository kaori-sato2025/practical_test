...
from db_control.mymodels import Base, Customers
...
def insert_sample_data():
    ...
    customers = [
        Customers(customer_id="C112", customer_name="あおさん", age=26, gender="男"),
        Customers(customer_id="C111", customer_name="ああさん", age=6, gender="男"),
